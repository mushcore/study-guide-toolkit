## ADD-NEW-COURSE.md §Stage 4 — Mock-exam assembly
...
- ≥5 questions tagged `pretest` — intended for day-one attempt before content review.
- ≥2 surface forms per deep concept — same concept, different numbers / framings / contexts.

Do NOT reuse past-exam questions verbatim. Generate novel questions testing the same concepts, with distractors drawn from real past-exam wrong-answer patterns.
