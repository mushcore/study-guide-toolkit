...
**Pitfall 1:** Encrypting passwords instead of hashing. The server holds the decryption key. An attacker with server access can reverse every stored password in one step. Hashing removes this risk entirely.
