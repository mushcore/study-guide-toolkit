...
> **Pitfall:** Placing WHERE after GROUP BY is a syntax error. Filtering on an aggregate with WHERE (instead of HAVING) also fails — the database evaluates WHERE before it computes the aggregate.
