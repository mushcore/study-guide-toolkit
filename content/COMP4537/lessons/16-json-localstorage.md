...
> **Pitfall**
> localStorage is browser-specific. Data stored in Chrome is not accessible from Firefox, even on the same machine. "Persistent" means persistent within a single browser, not across all browsers on the device.
