...
> **Pitfall**
> The correct parts are header, payload, and signature. ISAQuiz11 Q5 offers "Header, Payload, and Certificate" and "Header, Body, and Footer" as distractors. Certificate and Body are not JWT terms. Selecting either scores zero.
...
> **Pitfall**
> Omitting both `HttpOnly` and `Secure` on the JWT cookie exposes the token to XSS, CSRF, and unauthorized access simultaneously. ISAQuiz11 Q8 correct answer is "All of the above." A student who selected only XSS scored zero. All three risks are present, not just one.
