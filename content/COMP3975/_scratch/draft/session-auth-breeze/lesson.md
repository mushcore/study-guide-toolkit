...
> **Note**
> The voice guide for this course specifies `Auth::user()` and `Auth::id()` (facade style). Do not substitute `auth()->user()` — both work, but the professor uses the facade form.
