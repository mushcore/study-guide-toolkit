...
The order above matches the canonical ordering in Azure Functions documentation: HTTP, Timer, Queue, Blob, Event Hub.
...
> **Pitfall:** The GitHub Actions `.yml` file is auto-generated by Azure when you link the repo. Always pull it into your local repo before making edits — pushing without pulling first overwrites the auto-generated workflow and breaks the build.
