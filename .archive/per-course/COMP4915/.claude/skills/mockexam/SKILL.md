...
**Part 1: Multiple Choice** (2 marks each)
Each question: stem + options + correct answer + explanation of why
each distractor is wrong

**Part 2: True/False** (1 mark each)
Each question: statement + correct answer + explanation

**Part 3: Short Answer** (3 marks each)
Each question: prompt + model answer + scoring rubric (what earns full marks)

**Part 4: Essay** (10 marks each)
Each question: prompt + model answer + scoring rubric + common mistakes
...
- Include questions on Linux commands, file permissions, networking, and system admin
