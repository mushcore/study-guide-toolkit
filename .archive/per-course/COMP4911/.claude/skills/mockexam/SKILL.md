...
and the review slides.

## Process
1. Read `generated/diagnosis.md` for exam format and topic weights
2. Read past exams and review slides to match question style and difficulty
...
7. Balance questions across both pillars: RUP/process AND EJB/technical
