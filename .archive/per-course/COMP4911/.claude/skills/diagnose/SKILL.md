...
6. Pay special attention to the two review slide decks:
   - `Comp4911ReviewProcess.pdf` — process review topics
   - `Comp4911ReviewTechnical.pdf` — technical review topics
   These indicate what the instructor considers most important for the final.
7. If `graphify-out/GRAPH_REPORT.md` exists, cross-reference your topic
   ...
   surprising connections between the process and technical pillars that the
   graph found — these cross-pillar links are prime exam material.
