...
namespace NorthwindLibrary.Migrations
{
    ...
    [Migration("20260109214550_StoredProcs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.AlphabeticalListOfProduct", b =>
                {
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.CategorySalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.CurrentProductList", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Customer", b =>
                {
                    b.Property<string>("CustomerId")
                        .HasMaxLength(5)
                        .HasColumnType("nchar(5)")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.CustomerAndSuppliersByCity", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.CustomerDemographic", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .HasMaxLength(10)
                        .HasColumnType("nchar(10)")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Employee", b =>
                {
                    b.Property<int>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Invoice", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
                    ...
                    b.Property<short>("Quantity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasDefaultValue((short)1, "DF_Order_Details_Quantity");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.OrderDetailsExtended", b =>
                {
                    b.Property<float>("Discount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.OrderSubtotal", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.OrdersQry", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<short?>("ReorderLevel")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasDefaultValue((short)0, "DF_Products_ReorderLevel");
                    ...
                    b.Property<short?>("UnitsInStock")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasDefaultValue((short)0, "DF_Products_UnitsInStock");

                    b.Property<short?>("UnitsOnOrder")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasDefaultValue((short)0, "DF_Products_UnitsOnOrder");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.ProductSalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.ProductsAboveAveragePrice", b =>
                {
                    b.Property<string>("ProductName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.ProductsByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.QuarterlyOrder", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Region", b =>
                {
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.SalesByCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("CategoryID");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.SalesTotalsByAmount", b =>
                {
                    b.Property<string>("CompanyName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Shipper", b =>
                {
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.SummaryOfSalesByQuarter", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.SummaryOfSalesByYear", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Territory", b =>
                {
                    b.Property<string>("TerritoryId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("CustomerCustomerDemo", b =>
                {
                    b.HasOne("NorthwindLibrary.NW.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers");

                    b.HasOne("NorthwindLibrary.NW.CustomerDemographic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    b.HasOne("NorthwindLibrary.NW.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("NorthwindLibrary.NW.Territory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Employee", b =>
                {
                    b.HasOne("NorthwindLibrary.NW.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Order", b =>
                {
                    b.HasOne("NorthwindLibrary.NW.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("NorthwindLibrary.NW.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("NorthwindLibrary.NW.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.OrderDetail", b =>
                {
                    b.HasOne("NorthwindLibrary.NW.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .IsRequired()
                        .HasConstraintName("FK_Order_Details_Orders");

                    b.HasOne("NorthwindLibrary.NW.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Product", b =>
                {
                    b.HasOne("NorthwindLibrary.NW.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("NorthwindLibrary.NW.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("NorthwindLibrary.NW.Territory", b =>
                {
                    b.HasOne("NorthwindLibrary.NW.Region", "Region")
